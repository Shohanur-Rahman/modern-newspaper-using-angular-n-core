...
namespace App.Common.Constant
{
    ...
    public static class ConstantMessaages
    {
        ...
        public const string Deleted_Success = "Data successfully deleted.";
        public const string AllReadyExist = "Data already exists.";
